      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 about-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 relative about-content h-[40vh] lg:h-[70vh] w-full rounded-3xl group shadow-xl">
            ...
            <div className="absolute bottom-6 left-6 right-6 p-6 bg-white/80 backdrop-blur-xl border border-dark/10 rounded-2xl transform translate-y-4 opacity-100 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-100 z-10 shadow-sm">
